...
export const routes: Routes = [
  ...
  {path: 'user-list', component: UserListComponent, canActivate: [RegulGuard], runGuardsAndResolvers: 'always' },
  {path: 'user-create', component: UserCreateComponent, canActivate: [RegulGuard], runGuardsAndResolvers: 'always' },
  {path: 'user-details/:user-id', component: UserDetailsComponent, canActivate: [RegulGuard], runGuardsAndResolvers: 'always' },
